...
# Absract Base Class for Missing Values Analysis
...
class MissingValuesAnalysisTemplate(ABC):
    ...
    def analyze(self, df: pd.DataFrame):
        """
        Performs a complete missing values analysis by identifying and visualizing missing vlaues.
...
# This class implements method to identify and visualize missing values in the dataframe.
...
if __name__ == "__main__":
    ...
    #Load the data
    df = pd.read_csv(r"D:\Yash-python\python\Tasks\Prediction_2.0\extracted_data\AmesHousing.csv")
